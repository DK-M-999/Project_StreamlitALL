...
st.sidebar.image("data/logo2.png",caption="EmployeeEcho Insights")
theme_plotly = None 
...
def main():
    ...
    skew_fig.update_xaxes(showgrid=True, gridwidth=1, gridcolor='#1f252b')  # Add gridlines on x-axis
    skew_fig.update_yaxes(showgrid=True, gridwidth=1, gridcolor='#1f252b')  # Add gridlines on y-axis
