   ...
   if type_of_column=='Categorical':
    ...
    fig.update_layout(
      legend_title=None,
        ...
        xaxis=dict(showgrid=True, gridcolor='rgba(0, 0, 0, 0.1)'),  # Show x-axis grid and set its color
        yaxis=dict(showgrid=True, gridcolor='rgba(0, 0, 0, 0.1)'),  # Show y-axis grid and set its color
