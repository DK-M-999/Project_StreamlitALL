...
with c1:
    ...
    st.plotly_chart(scatter_fig, key="scatter_plot", use_container_width=True)
...
with c2:
    ...
    st.plotly_chart(box_fig, key="box_plot", use_container_width=True)
...
with d2:
    ...
    st.plotly_chart(box_fig_lof, use_container_width=True, key="lof_outlier_boxplot")
